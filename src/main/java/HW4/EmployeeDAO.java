...
public class EmployeeDAO {
    ...
    private static final String URL = "jdbc:sqlite:C:\\Users\\dev\\IdeaProjects\\JavaCourseHomeWorks\\src\\main\\java\\HomeWorks\\HW4\\hr.db";
    ...
    public void INSERT_EMPLOYEE(Employee employee) throws SQLException {
    ...
    public void UPDATE_EMPLOYEE(Employee employee) throws SQLException {
        Connection conn = DriverManager.getConnection(URL);
    ...
    public ArrayList<Employee> SELECT_ALL_EMPLOYEES() throws SQLException {
        Connection conn = DriverManager.getConnection(URL);
